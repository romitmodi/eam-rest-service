...
public class TeamController {
    ...
    public ResponseEntity<TeamDetails> getTeams(@PathVariable("id") Long id) throws ResourceNotFoundException {

        TeamDetails teamDetails = teamService.getTeamDetails(id);
        return new ResponseEntity<>(teamDetails, HttpStatus.ACCEPTED);
